...
$(document).ready(function(){
	...
	$('.slick-next').addClass('btn');
	$('.slick-prev').addClass('btn');
	$('.slick-prev').addClass('_active');
	$('.slick-next').click(function(){
		$('.slick-next').addClass('_active');
		$('.slick-prev').removeClass('_active');
	});
	$('.slick-prev').click(function(){
		$('.slick-prev').addClass('_active');
		$('.slick-next').removeClass('_active');
	});
	function arrowsSyncWithSlide(){
		if($('#slider-item-last.slick-active')){
			alert('hi');
		}
	}
})
